...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Styles -->
        <style>   <!-- <div class="col-md-3 text-center">
            <!-- Profile Image -->
...
@section('content')
<div class="col-lg-7 offset-4"  style="margin-top:100px">
             <div class="card">
              <div class="card-body">
                 <h3>Dynamic Form</h3>
                 <div class="text-center mb-3">
                <button type="button" class="btn btn-primary" onclick="showPersonal()">Personal</button>
                <button type="button" class="btn btn-success" onclick="showOffice()">Office</button>
            </div>
              </div>
             </div>

          <div class="card " id="personalForm">
            <div class="card-body">
              ...
              <form class="row g-3" >
                ...
                <div class="row mt-3">
                  <div class="col-md-3 ">
                    <img src="{{url('public/admin/assets/img/profile-img.jpg')}}"  width="160px" alt="Profile">
                    <div class="pt-2">
    ...
    function showPersonal() {
        ...
        document.getElementById('officeForm').classList.add('d-none');
    }

    function showOffice() {
        document.getElementById('officeForm').classList.remove('d-none');
